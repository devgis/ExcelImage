...
namespace NPOI.HWPF.Model
{
    ...
    public class ListLevel
    {
        ...
        public ListLevel(byte[] buf, int offset)
        {
            ...
            offset += NPOI.Util.LittleEndianConsts.INT_SIZE;
            _nfc = buf[offset++];
            _info = buf[offset++];
            ...
            offset += NPOI.Util.LittleEndianConsts.INT_SIZE;  //LittleEndianConsts.INT_SIZE;
            ...
            offset += NPOI.Util.LittleEndianConsts.SHORT_SIZE;
